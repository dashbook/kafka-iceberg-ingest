...
pub struct ArtifactSearchResults {
    ...
    pub artifacts: Vec<crate::models::SearchedArtifact>,
...
impl ArtifactSearchResults {
    /// Describes the response received when searching for artifacts.
    pub fn new(artifacts: Vec<crate::models::SearchedArtifact>, count: i32) -> ArtifactSearchResults {
