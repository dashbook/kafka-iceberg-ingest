...
pub struct VersionSearchResults {
    ...
    pub versions: Vec<crate::models::SearchedVersion>,
}

impl VersionSearchResults {
    /// Describes the response received when searching for artifacts.
    pub fn new(count: i32, versions: Vec<crate::models::SearchedVersion>) -> VersionSearchResults {
